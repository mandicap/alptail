<div
    ...
    <template x-for="(email, index) in emails">
        <div class="flex items-center space-x-2">
            <input x-model="emails[index]" :x-ref="`email-${index}`" @keydown.enter="addEmail" :key="index" type="email" class="rounded border border-gray-300 px-3 py-2 text-gray-700 w-full focus:outline-none focus:shadow-outline" placeholder="Enter their email here...">
