...
@section('content')
    <div
        ...
        <template x-for="star in ratings">
            <button @click="rating = star" @mouseover="hoverRating = star" @mouseleave="hoverRating = rating" aria-hidden="true" class="rounded-sm focus:outline-none focus:shadow-outline p-1">
                <svg :class="{ 'text-gray-600' : hoverRating >= star, 'text-yellow-400' : rating >= star }" class="w-8 text-gray-400 fill-current transition duration-150 cursor-pointer" viewBox="0 -10 511.991 511" xmlns="http://www.w3.org/2000/svg">
